...
public class Address {
	...
	public InetAddress getInetAddress() throws UtilityException, UnknownHostException {
		...
		address[0] = UtilityManager.integerToOneByte(firstOctet);
		address[1] = UtilityManager.integerToOneByte(secondOctet);
		address[2] = UtilityManager.integerToOneByte(thirdOctet);
		address[3] = UtilityManager.integerToOneByte(fourthOctet);
